...
public class TransactionBean  implements Comparable<TransactionBean> {
    ...
    private long   amount;
	private String execute_date;  //2015-01-20
    ...
    public void   setTransaction_id(int i)        { transaction_id = i;     }
    ...
    public void   setTransaction_type(int i)      { transaction_type = i;   }
	...
	public int compareTo(TransactionBean t) {
    	...
    	df.setLenient(false);
		try {
			return df.parse(this.execute_date).compareTo(df.parse(t.execute_date));
